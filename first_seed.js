...
//       var ingredientsArray = recipe.ingredientSchema;
//       var proteinVal = 0;
//       var carbVal = 0;
//       var fatVal = 0;
...
// function initialAPICall(manyrequestfunction){
//   return new Promise(function(resolve, reject){
//     // async call
//     something(function(err, asyncresults){
//       if(error){

//       }
//       else{

//         var thingToRender = manyrequestfunction(asyncresults);

//         resolve(thingToRender)
//       }
//     })
//   })
// }
...
// function manyrequestfunction(asyncresults){
//   var arrayOfPromises = [];
//   // asyncresults returns an array of id's
//   asyncresults.forEach(function(result){
//     var id  = result.id;
//     var secondaryRequest = new Promise(function(resolve, reject){
//       makeAnotherRequest(id, fucntion(error, result){
//         var finalDataItemInArray = // process the results, maybe put them in a new array or object
//         resolve(finalDataItemInArray)
//       })
//     })
//     arrayOfPromises.push(secondaryRequest)
//   })
